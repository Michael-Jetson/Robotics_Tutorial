...
```
   ...
   (mode/相位)           §56.8 三种实现哲学        §56.6 接触序列优化
        |                     |                     |
...
### 56.6.6 路线三点五:实时 Contact-Implicit MPC——把接触发现搬进控制循环 ⭐⭐⭐⭐
...
```
          Five approaches to contact sequence
...
| 足式/140_落脚点规划经典方法-59 落脚点规划 | 从预定义步态扩展到感知驱动/优化驱动的落脚点选择 |
