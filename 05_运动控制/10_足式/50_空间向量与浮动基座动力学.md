...
>
> **前置依赖**：Eigen 基础（02_基础/40_通用库剖析）、李群与 manif（01_数学/20_微分几何与李群，SE(3)/SO(3)/伴随表示）、足式/30_Pinocchio深度精读（Pinocchio Model-Data 架构）
>
...
1. **[02_基础/40_通用库剖析]** 给定 $3 \times 3$ 反对称矩阵 $[\boldsymbol{\omega}]_\times$，写出它的显式形式。它与叉积 $\boldsymbol{\omega} \times \boldsymbol{v}$ 的关系是什么？
