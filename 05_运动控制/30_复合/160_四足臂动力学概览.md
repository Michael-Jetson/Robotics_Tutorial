...
\mathbf{S}^{T}\boldsymbol{\tau}
+
\mathbf{J}_{c}^{T}(q)\boldsymbol{\lambda}
\tag{86.3B-1}
$$
...
$$
\mathbf{J}_{c}\dot{\mathbf{v}}+\dot{\mathbf{J}}_{c}\mathbf{v}=\mathbf{0}
\tag{86.3B-2}
$$
...
\mathbf{P}
=
\mathbf{I}-\mathbf{J}_c^{T}\left(\mathbf{J}_c\mathbf{M}^{-1}\mathbf{J}_c^{T}\right)^{-1}\mathbf{J}_c\mathbf{M}^{-1}
\tag{86.3B-3}
$$
...
$$
\mathbf{P}\,\mathbf{J}_c^{T}\boldsymbol{\lambda}
=
\mathbf{J}_c^{T}\boldsymbol{\lambda}
-
\mathbf{J}_c^{T}\left(\mathbf{J}_c\mathbf{M}^{-1}\mathbf{J}_c^{T}\right)^{-1}\underbrace{\mathbf{J}_c\mathbf{M}^{-1}\mathbf{J}_c^{T}}_{\text{与括号内互逆}}\boldsymbol{\lambda}
=
\mathbf{J}_c^{T}\boldsymbol{\lambda}-\mathbf{J}_c^{T}\boldsymbol{\lambda}
=\mathbf{0}
\tag{86.3B-4}
$$
...
$$
\mathbf{P}\mathbf{M}\dot{\mathbf{v}}+\mathbf{P}\mathbf{h}
=
\mathbf{P}\mathbf{S}^{T}\boldsymbol{\tau}
\tag{86.3B-5}
$$
...
$$
\boxed{
\mathbf{M}_{b}\dot{\mathbf{v}}+\mathbf{h}_{b}
=
\mathbf{J}_{c,b}^{T}\boldsymbol{\lambda}
}
\tag{86.3B-7}
$$
...
\dot{\mathbf{v}}
=
\mathbf{N}\dot{\mathbf{v}}_{f}
-
\mathbf{J}_c^{+}\dot{\mathbf{J}}_c\mathbf{v}
\tag{86.3B-8}
$$
...
$$
\tilde{\mathbf{M}}=\mathbf{N}^{T}\mathbf{M}\mathbf{N}
\tag{86.3B-9}
$$
...
\dot{\mathbf{x}}_{ee}
=
\mathbf{J}_{ee}\mathbf{v}
=
\begin{bmatrix}
\mathbf{J}_{ee,b} & \mathbf{J}_{ee,\ell} & \mathbf{J}_{ee,a}
\end{bmatrix}
\begin{bmatrix}
\mathbf{v}_b\\
\dot{\mathbf{q}}_\ell\\
...
\end{bmatrix}
=
\mathbf{J}_{ee,b}\mathbf{v}_b
+
\mathbf{J}_{ee,\ell}\dot{\mathbf{q}}_\ell
+
\mathbf{J}_{ee,a}\dot{\mathbf{q}}_a
\tag{86.4B-1}
$$
...
$$
\mathbf{A}_{G,b}\,\mathbf{v}_b+\mathbf{A}_{G,a}\,\dot{\mathbf{q}}_a=\mathbf{k}_G=\text{const}
\tag{86.4B-2}
$$
...
\mathbf{v}_b
=
-\,\mathbf{A}_{G,b}^{-1}\,\mathbf{A}_{G,a}\,\dot{\mathbf{q}}_a
}
\tag{86.4B-3}
$$
...
$$
\underbrace{\mathbf{M}_{bb}\dot{\mathbf{v}}_b}_{\text{基座自身惯性}}
+
\underbrace{\mathbf{M}_{b\ell}\ddot{\mathbf{q}}_\ell}_{\text{腿反作用}}
+
\underbrace{\mathbf{M}_{ba}\ddot{\mathbf{q}}_a}_{\text{臂反作用}}
+
\mathbf{h}_b
=
\mathbf{J}_{c,b}^{T}\boldsymbol{\lambda}
...
$$
\mathbf{J}_{ee}\dot{\mathbf{v}}+\dot{\mathbf{J}}_{ee}\mathbf{v}=\ddot{\mathbf{x}}_{ee}^{des}
\tag{86.4B-5}
$$
