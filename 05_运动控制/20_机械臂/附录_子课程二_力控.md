...
| ★★★★★ | **Pinocchio** | stack-of-tasks/pinocchio | 见调研报告/项目主页 | 操作空间 $\Lambda$/J̄/N 计算 | F02, F07 |
...
| v8 章节 | 力控大纲衔接 | 衔接说明 |
|---------|------------|---------|
| Ch11 Eigen 深度 | F02, F04, F07 | $\Lambda$/J̄/N 计算;Map 零拷贝;固定大小类型 |
| Ch12-14 模板 | F04, F05 | ros2_control ControllerInterface;CRTP 在力控中不常用 |
| Ch17 Ceres | F02 | Hessian 结构 ≅ 操作空间 $\Lambda$ 的 Schur 补 |
