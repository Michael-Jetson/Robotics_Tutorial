...
> **难度**：⭐⭐⭐⭐ | **建议用时**：2 周 | **前置要求**：线程管理与互斥同步 线程与互斥，原子操作与内存模型 原子与内存模型，C++语言进阶/Eigen基础与SLAM数学预备 Eigen 数据结构，C++语言进阶/Concepts与Policy Concepts 与 Policy 设计
...
Eigen 的表达式模板和 SIMD 已在 C++语言进阶/Eigen基础与SLAM数学预备 讨论。
...
这和 C++语言进阶/Concepts与Policy 的 Policy 思想一致。
