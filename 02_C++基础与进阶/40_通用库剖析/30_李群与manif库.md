...
**练习 23.16.1** ⭐⭐⭐：写出 $SE_2(3)$ 的 $5 \times 5$ 矩阵表示的群操作（乘法）和逆运算。验证结果满足群公理（封闭性、结合律、单位元、逆元）。

**练习 23.16.2** ⭐⭐⭐⭐：阅读 Barrau & Bonnabel 2017 "The Invariant Extended Kalman Filter as a Stable Observer" 的第 2-3 节，总结 InEKF 相比 ESKF 的核心优势。用自己的语言解释"不变误差动力学"是什么意思。
