...
> **难度**：⭐⭐～⭐⭐⭐⭐ | **建议用时**：2 周 | **前置要求**：C++语言进阶/错误处理与异常安全 错误处理、并发与系统编程/线程管理与互斥同步 线程同步、并发与系统编程/实时约束与高性能数据传递 实时约束、代码质量测试与调试 测试与质量工具
...
如果下面的问题答不出两题以上，建议先回顾 C++语言进阶/错误处理与异常安全、并发与系统编程/线程管理与互斥同步、并发与系统编程/原子操作与内存模型、并发与系统编程/实时约束与高性能数据传递 和 代码质量测试与调试 的相关内容。
...
这和 C++语言进阶/RAII与智能指针 的 RAII 不冲突。
...
1. 结合 C++语言进阶/错误处理与异常安全 的异常安全，设计一个配置加载流程：
