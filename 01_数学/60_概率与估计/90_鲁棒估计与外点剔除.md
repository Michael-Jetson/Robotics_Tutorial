...
12. **χ² gate 阈值在 GTSAM 中带 0.5 因子**。GTSAM 的 `NonlinearFactor::error` 返回 $\tfrac12\|r\|^2_\Omega$，所以 `barcSq = 0.5·Chi2inv(α, dof)`——和 Yang'20 论文的 $\bar c^2=\chi^2_{n,\alpha}$ 差一个因子 2。跨软件对比阈值时要乘除 2。
