...
- **主线（必读）**：§4.1 → §4.2 → §4.3 → §4.5 → §4.7 → §4.8 → §4.9。这条线让你理解"为什么不可微、怎么用 IFT 算、为什么随机平滑救了场、为什么会病态、用哪个工具"。
...
这段历史脉络是本专题的暗线：**§4.3（凸松弛 IFT）代表第二阶段的成熟形态，§4.5（随机平滑）代表第三阶段的核心洞察，§4.6（统一）和 §4.7（病态诊断）则是站在今天回望、把两个阶段的认识缝合起来。**
