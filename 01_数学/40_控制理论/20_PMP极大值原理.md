...
Lev Pontryagin（1908-1988）14岁时因化学实验事故双目失明，此后全部数学学习依赖母亲朗读文献和同事口述。尽管如此，他成为20世纪最杰出的拓扑学家之一（Pontryagin 对偶定理、Pontryagin 类）。1956年，在学生 Boltyanskii、Gamkrelidze 和 Mishchenko 的协助下，他开始转向最优控制理论。
