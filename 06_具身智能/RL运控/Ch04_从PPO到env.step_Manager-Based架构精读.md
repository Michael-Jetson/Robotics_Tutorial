...
如果你没有用过 legged_gym（Isaac Gym 时代的标准框架，CoRL 2021，2.8k Stars），可能不理解为什么需要 Manager-Based 架构。毕竟，"把所有代码写在一个文件里"看起来更简单。但当你的项目复杂到需要同时实验 5 种 reward 配置、3 种 obs 组合、2 种 DR 策略时——单体架构的"简单"会变成"噩梦"。
